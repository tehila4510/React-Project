...
const sendMessage = async (text) => {
  ...
  try {
    ...
    setHistory(data.updatedHistory.map((h) => ({
      role: h.role,
      text: h.text
    })));
    ...
    <>
      ...
      <div className="chat-page">
        ...
        <div className="chat-header">
          <div className="chat-teacher-avatar">🦉</div>
        ...
        <div className="chat-messages">
          ...
          {messages.length === 0 && !loading && (
            <div className="chat-welcome">
              <span className="chat-welcome-owl">🦉</span>
              <div className="chat-welcome-title">
                Hi {currentUser?.firstName || 'there'}! I'm your English teacher 👋
              </div>
              <div className="chat-welcome-sub">
                Ask me anything in English! I'll correct your mistakes, explain grammar,
                teach vocabulary, and always reply with a follow-up question to keep you practicing.
              </div>
